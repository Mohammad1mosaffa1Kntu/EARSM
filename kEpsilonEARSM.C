...
void kEpsilonEARSM<BasicMomentumTransportModel>::correctNut()
{
...
template<class BasicMomentumTransportModel>
void kEpsilonEARSM<BasicMomentumTransportModel>::correctNonlinearStress(const volTensorField& gradU)
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix> kEpsilonEARSM<BasicMomentumTransportModel>::kSource() const
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix> kEpsilonEARSM<BasicMomentumTransportModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicMomentumTransportModel>
kEpsilonEARSM<BasicMomentumTransportModel>::kEpsilonEARSM
(
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
template<class BasicMomentumTransportModel>
bool kEpsilonEARSM<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
void kEpsilonEARSM<BasicMomentumTransportModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
